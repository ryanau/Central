...
ActiveRecord::Schema.define(version: 20160520155102) do
  ...
  create_table "demo_volunteers", force: :cascade do |t|
    t.string   "first_name"
    t.string   "last_name"
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.float    "question_order",                 null: false
    t.integer  "task_id"
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
    t.boolean  "object_tag",     default: false
    t.boolean  "verb_tag",       default: false
  end
  ...
  create_table "verb_tags", force: :cascade do |t|
